...
const uint32_t c_uiBaud[5] = {9600, 115200, 19200, 38400, 57600};

void setup() {
  // put your setup code here, to run once:
  Serial.begin(115200);
	WitInit(WIT_PROTOCOL_BLE , 0x00);
...
void loop() {
    ...
    //}
			...
			if(s_cDataUpdate & GYRO_UPDATE)
      {
        Serial.print("Gryo >>\r\n");
        Serial.print("gx: ");
        Serial.print(fGryo[0], 3);
        Serial.print(" gy: ");
        Serial.print(fGryo[1], 3);
        Serial.print(" gz: ");
        Serial.print(fGryo[2], 3);
        Serial.print("\r\n");
...
static void GetData(void)
{
  for(int i = 0 ;i < 3 ; i++)
  {
    ...
    fGryo[i] = sReg[GX+i] / 32768.0f * 2000.0f;
